...
const scriptSrc = isDev
  ? "script-src 'self' 'unsafe-inline' 'unsafe-eval' plausible.io challenges.cloudflare.com va.vercel-scripts.com"
  : "script-src 'self' 'unsafe-inline' plausible.io challenges.cloudflare.com va.vercel-scripts.com"
...
const securityHeaders = [
  ...
  // Content Security Policy — strict whitelist
  {
    ...
    value: [
      ...
      "connect-src 'self' *.supabase.co plausible.io challenges.cloudflare.com vitals.vercel-insights.com",
